...
namespace RickAndMortyLibrary.ServerSide
{
    ...
    internal static class CardsImporter
    {
        ...
        static CardsImporter()
        {
            ...
            {
                new PersonalityCard(0, "Паразит", personalityCardsPath + "enemy.jpg", 18),
                new PersonalityCard(1, "Друг", personalityCardsPath + "friend.jpg", 6),
            };

            playerPersonalityCards = new PersonalityCard[]
            {
                new PersonalityCard(0, "Паразит", personalityCardsPath + "enemy.jpg", 2),
                new PersonalityCard(1, "Друг", personalityCardsPath + "friend.jpg", 4),
            };
        }
